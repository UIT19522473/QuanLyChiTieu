...
const Home = ({navigation}) => {
  ...
  return (
    <SafeAreaView className="flex-1 pt-3 bg-primary">
      ...
      <View className="bg-slate-100 flex-1">
        <View className="flex-1 relative">
          ...
          <FloatingAction
            ...
            onPressItem={name => {
              name === 'DanhMuc'
                ? openBottomSheet('DanhMuc') // navigation.navigate('AddItemHomeStack', {name: 'demo'})
          ...
          <RBSheet
            ...
            {tab === 'DanhMuc' ? (
              <AddItemHome refRBSheet={refRBSheet} />
            ) : (
              <AddTransferHome />
            )}
          </RBSheet>
      ...
      {/* <TouchableOpacity
        // onPress={() => navigation.navigate('ChooseItemStack')}
        onPress={() => testLogin()}>
        <Text>onTest</Text>
      </TouchableOpacity>

      <TouchableOpacity
        className="mt-4 p-4 bg-red-600"
        // onPress={() => navigation.navigate('ChooseItemStack')}
