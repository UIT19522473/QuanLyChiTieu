...
//     (this.curExpense = curExpense), (this.type = type);
//   }
//   *getIntervalDay() {
//     let start = new Date(this.startTimeAsMillis);
//     let end = new Date(this.endTimeAsMillis);
...
//           <Image
//             source={require('../../asset/restaurant.png')}
//             style={styles.icon}
//           />
...
//           <Text style={styles.paragraphs} name="expense-type">
//             ({item.type})
//           </Text>
//           <Text stylel={styles.paragraphs} name="expense-amount">
//             {item.curExpense} VND
//           </Text>
//         </View>
//       </View>
...
//   render() {
//     return <FlatList data={this.plans} renderItem={rederPlanCard} />;
//   }
// }
...
const HanMuc = ({navigation}) => {
  const onDisplayNotification = async () => {
    ...
    await notifee.displayNotification({
      title: 'Master Money',
      body: 'Han muc: Demo da boi chi. Ban hay dieu chinh thoi quen chi tieu nhe!',
      android: {
        channelId,
  ...
  return (
    <View>
      <TouchableOpacity onPress={() => navigation.navigate('TienIchHome')}>
        <Text>Back tien ich</Text>
      </TouchableOpacity>
      <TouchableOpacity
        onPress={() => onDisplayNotification()}
        className="bg-amber-500 p-4">
        <Text>Create Push</Text>
      </TouchableOpacity>
    </View>
  );
};
