import { Button, StyleSheet, Text, View, SafeAreaView, ActivityIndicator } from 'react-native'
...
return (
  <SafeAreaView style={styles.container}>
    <MoneyHeader onMoneyChange={handleMoneyChange} base={base} value={money} symbol={baseSymbol} />
    ...
    <ScrollView>
      {filterCurrencyList.map(item => (
        <InternationalView unit={item.name} unitLogo={item.symbol} uriFlag={item.uriFlag} currentRate={item.rate} pickedUnit={base} amount={item.amount} />
      ))}
    </ScrollView>
